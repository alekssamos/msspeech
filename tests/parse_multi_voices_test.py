...
async def test_parse_multivoices_wwith_default_params(mss):
    ...
    expected_ssml = "<voice  name='en-US-GuyNeural'><prosody pitch='0Hz' rate ='+0%' volume='100'> Hi, Aria!</prosody></voice>\n\n<voice  name='en-US-AriaNeural'><prosody pitch='0Hz' rate ='+0%' volume='100'> Hello, Guy!</prosody></voice>".strip()
